...
public class MediaApi {
    ...
    public Media upload(String type, String filename, byte[] data) {
        ...
        String url = "https://api.weixin.qq.com/cgi-bin/media/upload?access_token=" + client.getAccessToken() + "&type=" + type;
    ...
    public String addVoice(String voice_id, String data) {
        ...
        String url = "https://api.weixin.qq.com/cgi-bin/media/voice/addvoicetorecofortext?access_token=" + client.getAccessToken() + "&format=mp3&voice_id=" + voice_id + "&lang=zh_CN";
        ResponseEntity<String> response = restTemplate.exchange(url, HttpMethod.POST, requestEntity, String.class);
        return response.getBody();
    }
    ...
    public String voice2Text(String mediaId) {
        ...
        headers.setContentType(MediaType.MULTIPART_FORM_DATA);
        MultiValueMap<String, String> request = new LinkedMultiValueMap<>();
        request.add("access_token", client.getAccessToken());
